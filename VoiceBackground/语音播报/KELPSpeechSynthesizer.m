...
@interface KELPSpeechSynthesizer () <AVSpeechSynthesizerDelegate>

@property (nonatomic, strong, readwrite) AVSpeechSynthesizer *speechSynthesizer;

@end
@implementation KELPSpeechSynthesizer
...
+ (instancetype)sharedSpeechSynthesizer
{
    ...
    dispatch_once(&onceToken, ^{
        sharedInstance = [[KELPSpeechSynthesizer alloc] init];
    });
